...
from rag_retriever.modules.doc_store.embedding.utils import get_Embeddings, get_vs_path
from rag_retriever.modules.doc_store.kb_cache import base as kb_cache_base
...
class ThreadSafeFaiss(kb_cache_base.ThreadSafeObject):
...
class _FaissPool(kb_cache_base.CachePool):
...
class MemoFaissPool(_FaissPool):
    ...
    def load_vector_store(self, kb_name: str, embed_model: str) -> ThreadSafeFaiss:
        self.atomic.acquire()
